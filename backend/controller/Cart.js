...
exports.addToCart = async (req, res) => {
  try {
    ...
    const [result, fields] = await connection.execute('INSERT INTO carts (quantity, product_id, user_id,price) VALUES (?, ?, ?,?)', [req.body.quantity, req.body.product_id, req.body.user_id,req.body.price]);
    connection.release();
