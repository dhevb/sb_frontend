...
exports.addToCart = async (req, res) => {
  try {
    ...
    const [result, fields] = await connection.execute('INSERT INTO carts (quantity, product_id, user_id,price,discount_price,title) VALUES (?, ?, ?,?,?,?)', [req.body.quantity, req.body.product_id, req.body.user_id,req.body.price,req.body.discount_price,req.body.title]);
    connection.release();
