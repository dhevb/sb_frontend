...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 13, 2024 at 11:00 AM
...
(1, 'swadeshi', 'products', 'images', '', 'image_jpeg', '', '', 'Input/Image_JPEG_Upload.php', '');
...
('root', '[{\"db\":\"swadeshi\",\"table\":\"users\"},{\"db\":\"swadeshi\",\"table\":\"orders\"},{\"db\":\"swadeshi\",\"table\":\"carts\"},{\"db\":\"swadeshi\",\"table\":\"products\"},{\"db\":\"swadeshi\",\"table\":\"categories\"},{\"db\":\"swadeshi\",\"table\":\"brands\"},{\"db\":\"swadeshi\",\"table\":\"login\"},{\"db\":\"swadeshi\",\"table\":\"cart\"}]');
...
('root', '2024-03-13 09:59:59', '{\"Console\\/Mode\":\"collapse\"}');
...
-- Database: `swadeshi`
--
CREATE DATABASE IF NOT EXISTS `swadeshi` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `swadeshi`;
